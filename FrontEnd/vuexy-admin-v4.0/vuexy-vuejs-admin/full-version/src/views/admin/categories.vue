    ...
    <div class="">
      <vs-table stripe>
        <template slot="thead">
          ...
          <vs-th>
            <vs-button class="mr-3 mb-2" @click="OpenPopupAddCategories()">Add</vs-button>
          </vs-th>
        </template>
        <template slot-scope="">
          <vs-tr :key="index" v-for="(item, index) in lst_categories">
            ...
            <vs-td>
              <vs-button class="mr-3 mb-2" @click="EditCategories(item)">Edit</vs-button>
              <vs-button class="mr-3 mb-2" @click="DeleteCategories(item.ID, item.Code)">Delete</vs-button>
            </vs-td>
          </vs-tr>
        </template>
      </vs-table>
...
export default {
    ...
    methods: {
      ...
      Delete() {
        var vm = this;
        axios.post("http://admin.bobbylct.com/api/categories/delete", null, { params: {
          id: vm.categories_id,
