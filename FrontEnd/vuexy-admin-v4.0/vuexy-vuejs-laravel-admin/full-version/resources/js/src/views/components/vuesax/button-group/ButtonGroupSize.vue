...
<template>
  <vx-card title="Sizing" code-toggler>
    ...
    <div class="btn-group">
      <vs-button size="large">Left</vs-button><vs-button size="large">Middle</vs-button><vs-button size="large">Right</vs-button>
    </div>

    <div class="btn-group my-4">
      <vs-button>Left</vs-button><vs-button>Middle</vs-button><vs-button>Right</vs-button>
    </div>

    <div class="btn-group">
      <vs-button size="small">Left</vs-button><vs-button size="small">Middle</vs-button><vs-button size="small">Right</vs-button>
    </div>
