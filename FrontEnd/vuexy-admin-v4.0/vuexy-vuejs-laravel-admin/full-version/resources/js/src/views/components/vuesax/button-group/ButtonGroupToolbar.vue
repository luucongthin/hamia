  ...
  <vx-card title="Toolbar" code-toggler>
    ...
    <div class="flex flex-wrap">
      <div class="btn-group mr-4 mt-4">
        <vs-button>1</vs-button><vs-button>2</vs-button><vs-button>3</vs-button><vs-button>4</vs-button>
      </div>

      <div class="btn-group mt-4 mr-4">
        <vs-button>5</vs-button><vs-button>6</vs-button><vs-button>7</vs-button>
      </div>
