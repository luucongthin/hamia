...
export default {
  data() {
    return {
      ...
      suggestedFriends: [
        { name: 'Carissa Dolle', avatar: require("@assets/images/portrait/small/avatar-s-5.png"),  mutualFriends: 6 },
        { name: 'Liliana Pecor', avatar: require("@assets/images/portrait/small/avatar-s-6.png"),  mutualFriends: 3 },
        { name: 'Isidra Strunk', avatar: require("@assets/images/portrait/small/avatar-s-7.png"),  mutualFriends: 2 },
        { name: 'Gerald Licea',  avatar: require("@assets/images/portrait/small/avatar-s-8.png"),  mutualFriends: 1 },
        { name: 'Kelle Herrick', avatar: require("@assets/images/portrait/small/avatar-s-9.png"),  mutualFriends: 1 },
        { name: 'Cesar Lee',     avatar: require("@assets/images/portrait/small/avatar-s-10.png"), mutualFriends: 1 },
        { name: 'John Doe',      avatar: require("@assets/images/portrait/small/avatar-s-11.png"), mutualFriends: 1 },
        { name: 'Tonia Seabold', avatar: require("@assets/images/portrait/small/avatar-s-12.png"), mutualFriends: 1 },
      ],
      userLatestPhotos: [
      ...
      userPosts: [{
          ...
          comments   : 77,
          usersLiked : [
            { name: 'Trina Lynes',       img: require("@assets/images/portrait/small/avatar-s-1.png") },
            { name: 'Lilian Nenez',      img: require("@assets/images/portrait/small/avatar-s-2.png") },
            { name: 'Alberto Glotzbach', img: require("@assets/images/portrait/small/avatar-s-3.png") },
            { name: 'George Nordick',    img: require("@assets/images/portrait/small/avatar-s-4.png") },
            { name: 'Vennie Mostowy',    img: require("@assets/images/portrait/small/avatar-s-5.png") },
          ],
          commentbox : '',
          usersCommented: [
            {
        ...
        },
        {
          ...
          comments   : 105,
          usersLiked : [
            { name: 'Lai Lewandowski',   img: require("@assets/images/portrait/small/avatar-s-6.png")  },
            { name: 'Elicia Rieske',     img: require("@assets/images/portrait/small/avatar-s-7.png")  },
            { name: 'Darcey Nooner',     img: require("@assets/images/portrait/small/avatar-s-8.png")  },
            { name: 'Julee Rossignol',   img: require("@assets/images/portrait/small/avatar-s-10.png") },
            { name: 'Jeffrey Gerondale', img: require("@assets/images/portrait/small/avatar-s-9.png")  },
          ],
          commentbox: '',
          usersCommented: [
            {
      ...
      polls: [{
        ...
        options: [{
            ...
            voted      : 58,
            usersVoted : [
              { name: 'Tonia Seabold',  avatar: require("@assets/images/portrait/small/avatar-s-12.png") },
              { name: 'Carissa Dolle',  avatar: require("@assets/images/portrait/small/avatar-s-5.png") },
              { name: 'Kelle Herrick',  avatar: require("@assets/images/portrait/small/avatar-s-9.png") },
              { name: 'Len Bregantini', avatar: require("@assets/images/portrait/small/avatar-s-10.png") },
              { name: 'John Doe',       avatar: require("@assets/images/portrait/small/avatar-s-11.png") },
              { name: 'Tonia Seabold',  avatar: require("@assets/images/portrait/small/avatar-s-12.png") },
              { name: 'Dirk Fornili',   avatar: require("@assets/images/portrait/small/avatar-s-2.png") },
            ]
          },
          {
            ...
            voted      : 16,
            usersVoted : [
              { name: 'Liliana Pecor',      avatar: require("@assets/images/portrait/small/avatar-s-6.png") },
              { name: 'Kasandra Nalevanko', avatar: require("@assets/images/portrait/small/avatar-s-1.png") },
            ]
          },
          {
            text       : 'mark ruffalo',
            ...
            voted      : 8,
            usersVoted : [
              { name: 'Lorelei Lacsamana', avatar: require("@assets/images/portrait/small/avatar-s-4.png") },
            ]
          },
          {
            text       : 'Chris Evans',
            ...
            voted      : 16,
            usersVoted : [
              { name: 'Jeanie Bulgrin', avatar: require("@assets/images/portrait/small/avatar-s-8.png") },
              { name: 'Graig Muckey',   avatar: require("@assets/images/portrait/small/avatar-s-3.png") },
            ]
          },
        ]
      ...
      twitterFeeds: [
        {
          authorAvatar      : require("@assets/images/portrait/small/avatar-s-12.png"),
