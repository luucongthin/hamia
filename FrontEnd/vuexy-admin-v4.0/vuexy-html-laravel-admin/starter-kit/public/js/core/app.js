...
(function (window, document, $) {
  ...
  $(document).on("click", ".bookmark-input input", function (e) {
    $('.bookmark-wrapper .bookmark-input').addClass('show');
    $('.bookmark-input .search-list').addClass('show');
  }); // Favorite star click
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\vuesax-bootstrap-laravel-admin-template\vuesax-bootstrap-laravel-starterkit\resources\js\core\app.js */"./resources/js/core/app.js");
